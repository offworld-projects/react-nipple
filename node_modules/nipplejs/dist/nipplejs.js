...
u.applyImageStyle = function(el, bgImg) {
...
// Configuration
// add config function, you need to put the attribute in the default
// in order to make it work, check more on safeExtend
...
function Nipple (collection, options) {
    ...
    this.leftImg = options.leftImg;
    this.rightImg = options.rightImg;
    this.maxMove = options.maxMove;
    this.frontSize = options.frontSize;
...
Nipple.prototype.stylize = function () {
    ...
    styles.back = {
        ...
        background: this.backImg || this.options.color,
        backgroundSize: '100% 100%'
    };

    var newMarginLeft = -(this.options.size / 4);
    var newMarginTop = -(this.options.size / 4);
    var newWidth = this.options.size / 2;
    var newHeight = this.options.size / 2;

    if (this.options.frontSize != 0) {
        newMarginLeft = -(this.options.frontSize / 2);
        newMarginTop = -(this.options.frontSize / 2);
        newWidth = this.options.frontSize;
        newHeight = this.options.frontSize;
    }
...
Nipple.prototype.hide = function (cb) {
    ...
    u.applyImageStyle(self.ui.front, self.frontImg || self.color);
...
Collection.prototype.createNipple = function (position, identifier) {
    ...
    var nipple = new Nipple(self, {
        ...
        backImg: opts.backImg,
        upImg: opts.upImg,
        downImg: opts.downImg,
        leftImg: opts.leftImg,
        rightImg: opts.rightImg,
        maxMove: opts.maxMove,
...
Collection.prototype.processOnMove = function (evt) {
    ...
    var size = nipple.options.size / 4;
    if (opts.maxMove != 0) {
        size = opts.maxMove;
    }
    ...
    if (!opts.dataOnly) {
        ...
        if(yPosition != 0 && xPosition != 0) {
            ...
            u.applyImageStyle(nipple.ui.front, opts.frontImg || opts.color);
        }
        else if(xPosition != 0) {
            //x dir
            if(xPosition < 0) {
                u.applyImageStyle(nipple.ui.front, opts.leftImg || opts.frontImg || opts.color);
            }
            else {
                u.applyImageStyle(nipple.ui.front, opts.rightImg || opts.frontImg || opts.color);
            }
        }
        else {
            //y dir
            if(yPosition < 0) {
                u.applyImageStyle(nipple.ui.front, opts.upImg || opts.frontImg || opts.color);
            }
            else {
                u.applyImageStyle(nipple.ui.front, opts.downImg || opts.frontImg || opts.color);
            }
        }
    }
